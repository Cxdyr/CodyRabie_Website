...
class CodyBot:
    def __init__(self):
        ...
        self.personal_data = self.load_personal_data(os.path.join(os.path.dirname(__file__), 'data.json'))
        self.context = {}
        ...
        self.known_questions = {
            ...
            "When is your birthday?": ["When were you born", "What is your birth date", "when is your birthday?", "What is your birthday"],
